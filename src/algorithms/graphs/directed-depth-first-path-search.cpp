...
auto DirectedDepthFirstPathSearch::pathTo(int v) const -> const IntIterator * {
...
auto DirectedDepthFirstPathSearch::isConnectedToSource(int v) const -> bool {
    return visited[v];
}

auto DirectedDepthFirstPathSearch::visitedVertices() const -> int {
    return count;
}
